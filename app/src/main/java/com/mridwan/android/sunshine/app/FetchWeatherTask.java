...
/**
 * Created by mridwan on 12/19/15.
 */
...
//            Log.v(this.LOG_TAG,forecastJsonStr);
        ...
        String [] sArray = {"Error getting data"};
        try {
            sArray = this.getWeatherDataFromJson(forecastJsonStr,Integer.valueOf(NUM_DAYS));
